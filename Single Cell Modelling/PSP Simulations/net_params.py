...
con_PN2PN = 0.0003#0.00018 # BBP = 0.00031 // Seeman et al (2018) = 0.00037
con_PN2MN = 0.0003
con_PN2BN = 0.0003
con_PN2VN = 0.0003
...
#Stimulation Params (stim: 10% of PNs and 50% of BN/VNs)
PercentStim = 0.
PN_params = {'mname':'HL5PN1', 'num_cell': 70, 'num_stim': 10, 'interval': 10, 'stim_type': 'ProbAMPANMDA',
						'start_time': 6500.0, 'delay': 3.0, 'delay_std': 6., 'loc_num': int(150*PercentStim),'loc':'dend','idx_offset' : 0,
						'syn_params':{'tau_r_AMPA': taur_PN2PN, 'tau_d_AMPA': taud_PN2PN,
						'tau_r_NMDA': r_NMDA, 'tau_d_NMDA': 65, 'e': 0, 'Dep': d_PN2PN,
						'Fac': f_PN2PN, 'Use': use_PN2PN, 'u0':0, 'gmax': con_PN2PN }}
MN_params = {'mname':'HL5MN1', 'num_cell': 0, 'num_stim': 10, 'interval': 10, 'stim_type': 'ProbAMPANMDA',
						'start_time': 6500.0, 'delay': 3.0, 'delay_std': 6., 'loc_num': int(5*PercentStim),'loc':'dend','idx_offset' : 0,
						'syn_params':{'tau_r_AMPA': taur_PN2MN,'tau_d_AMPA': taud_PN2MN,
						'tau_r_NMDA': r_NMDA, 'tau_d_NMDA': 65, 'e': 0, 'Dep': d_PN2MN,
						'Fac': f_PN2MN, 'Use': use_PN2MN, 'u0':0, 'gmax': con_PN2MN }}
BN_params = {'mname':'HL5BN1', 'num_cell': 50, 'num_stim': 10, 'interval': 10, 'stim_type': 'ProbAMPANMDA',
						'start_time': 6500.0, 'delay': 3.0, 'delay_std': 6., 'loc_num': int(100*PercentStim),'loc':'dend','idx_offset' : 0,
						'syn_params':{'tau_r_AMPA': taur_PN2BN, 'tau_d_AMPA': taud_PN2BN,
						'tau_r_NMDA': r_NMDA, 'tau_d_NMDA': 65, 'e': 0, 'Dep': d_PN2BN,
						'Fac': f_PN2BN, 'Use': use_PN2BN, 'u0':0, 'gmax': con_PN2BN }}
VN_params = {'mname':'HL5VN1', 'num_cell': 25, 'num_stim': 10, 'interval': 10, 'stim_type': 'ProbAMPANMDA',
						'start_time': 6500.0, 'delay': 3.0, 'delay_std': 6., 'loc_num': int(100*PercentStim),'loc':'dend','idx_offset' : 0,
						'syn_params':{'tau_r_AMPA': taur_PN2VN, 'tau_d_AMPA': taud_PN2VN,
						'tau_r_NMDA': r_NMDA, 'tau_d_NMDA': 65, 'e': 0, 'Dep': d_PN2VN,
						'Fac': f_PN2VN, 'Use': use_PN2VN, 'u0':0, 'gmax': con_PN2VN }}
